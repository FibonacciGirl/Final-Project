...
data.model<-list(E=E, S0=matrix(c(0.4328403, 0.0406657, 0.0406657, 0.4222715),nrow=2,ncol=2), L0=matrix(c(0.4328403, 0.0406657, 0.0406657, 0.4222715),nrow=2,ncol=2),mu0= matrix(c(.5,.5),nrow=2,ncol=1), n = dim(Y)[2], p = dim(Y)[1], m=n.categories)
